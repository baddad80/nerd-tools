...
#include "../../emsdk/emscripten/1.38.31/system/include/emscripten/emscripten.h"
...
extern void progress( int progressValue, int progressAmount );


EMSCRIPTEN_KEEPALIVE int computeDigitValue( int p_Digit )
{
